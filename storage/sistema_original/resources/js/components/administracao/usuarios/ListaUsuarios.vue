    ...
    methods: {
        ...
        async carregarPermissoesDoPapel(papel) {
            try {
                ...
                const responsePermissoesAtuais = await axios.get(`/api/administracao/roles/${papel.id}/permissions`);
                this.permissoesAtuais = responsePermissoesAtuais.data || [];
                
                // Carregar todas as permissões disponíveis
                const responseTodasPermissoes = await axios.get('/api/administracao/permissions');
        ...
        async adicionarPermissaoAoPapel(permissao) {
            try {
                ...
                await axios.post(`/api/administracao/roles/${papelId}/permissions`, {
        ...
        async abrirModalGerenciarUsuarios(papel) {
            ...
            try {
                ...
                const responseAtuais = await axios.get(`/api/administracao/roles/${papel.id}/users`);
        ...
        async adicionarUsuarioAoPapel(usuario) {
            try {
                ...
                await axios.post(`/api/administracao/roles/${papelId}/users`, {
                    user_id: usuarioId
                });
        ...
        async abrirModalExclusaoInteligente(papel) {
            ...
            try {
                ...
                const responseUsuarios = await axios.get(`/api/administracao/roles/${papel.id}/users`);
                this.detalhesExclusao.usuarios = responseUsuarios.data || [];
                
                // Carregar detalhes das permissões vinculadas
                const responsePermissoes = await axios.get(`/api/administracao/roles/${papel.id}/permissions`);
        ...
        async excluirPapelComVinculos() {
            ...
            try {
                ...
                if (this.detalhesExclusao.permissoes.length > 0) {
                    ...
                    await axios.post(`/api/administracao/roles/${this.papelParaExcluir.id}/permissions`, {
                        permissions: []
                    });
                ...
                await axios.delete(`/api/administracao/roles/${this.papelParaExcluir.id}`, {
                    headers: {
        ...
        async salvarPapel() {
            ...
            try {
                const url = this.modoEdicaoPapel 
                    ? `/api/administracao/roles/${this.itemSelecionado.id}`
                    : '/api/administracao/roles';
        ...
        async carregarPapeis() {
            ...
            try {
                const response = await axios.get('/api/administracao/roles');
        ...
        async carregarPermissoes() {
            ...
            try {
                const response = await axios.get('/api/administracao/permissions');
        ...
        async salvarPermissao() {
            ...
            try {
                const url = this.modoEdicaoPermissao 
                    ? `/api/administracao/permissions/${this.itemSelecionado.id}`
                    : '/api/administracao/permissions';
        ...
        async verDetalhesPermissao(permissao) {
            ...
            try {
                ...
                const responsePapeis = await axios.get(`/api/administracao/permissions/${permissao.id}/roles`);
                this.papeisPermissao = responsePapeis.data;
                
                // Carregar usuários que possuem esta permissão
                const responseUsuarios = await axios.get(`/api/administracao/permissions/${permissao.id}/users`);
        ...
        async gerenciarPapeisPermissao(permissao) {
            ...
            try {
                ...
                const responseDisponiveis = await axios.get(`/api/administracao/permissions/${permissao.id}/available-roles`);
        ...
        async adicionarPapelAPermissao(papel) {
            try {
                await axios.post(`/api/administracao/permissions/${this.permissaoSelecionada.id}/roles/${papel.id}`);
        ...
        async removerPapelDaPermissao(papel) {
            try {
                await axios.delete(`/api/administracao/permissions/${this.permissaoSelecionada.id}/roles/${papel.id}`);
        ...
        async excluirPapelConfirmado() {
            const response = await axios.delete(`/api/administracao/roles/${this.itemParaExcluir.id}`, {
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                }
            });
        ...
        async excluirPermissaoConfirmada() {
            const response = await axios.delete(`/api/administracao/permissions/${this.itemParaExcluir.id}`);
        ...
        async removerUsuarioPapelConfirmado() {
            ...
            try {
                ...
                await axios.delete(`/api/administracao/roles/${papelId}/users/${usuarioId}`);
