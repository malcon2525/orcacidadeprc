<!-- 
 * Componente de Processamento de Composições e Insumos SINAPI
 * 
 * OBJETIVO: Interface para upload e processamento de arquivos Excel da tabela SINAPI
 * contendo composições e insumos (5 abas: ISD, ICD, CSD, CCD, Analítico)
 * 
 * ESTRUTURA:
 ...
 * 1. Upload: Validação e seleção do arquivo Excel
 * 2. Processamento: Envio para backend via API, execução de script Python
 * 3. Resultado: Geração de 5 arquivos processados + metadados
 * 
 * ESTADOS VISUAIS:
 ...
 * 
 * INTEGRAÇÃO:
 * - API: /api/tabela-oficial/importar-sinapi/processar-composicoes-insumos
 * - Backend: ImportarSinapiController@processarComposicoesInsumos
 * - Script Python: processa_composicoes_insumos.py
 -->
<template>
    <div>
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h5 class="mb-1 fw-bold" style="color: #18578A;">
                    <i class="fas fa-chart-bar me-2"></i>Processamento de Composições e Insumos da Tabela SINAPI (Sintético e Analítico)
                </h5>
                <p class="text-muted mb-0 small">Processe composições e insumos, com e sem desoneração, da tabela SINAPI (Sintético e Analítico)</p>
            </div>
        </div>
                ...
                <div class="workflow-card" :class="{ 
                    ...
                    <div class="card-header-section">
                        ...
                        <div class="card-title">
                            ...
                            <p class="mb-0 text-muted small">Selecione o Excel com as 5 abas (ISD, ICD, CSD, CCD, Analítico)</p>
                        </div>
                ...
                <div class="workflow-card" :class="{ 
                    ...
                    <div class="card-header-section">
                        ...
                        <div class="card-title">
                            ...
                            <p class="mb-0 text-muted small">Processando as 5 abas do arquivo Excel</p>
                        </div>
                    ...
                    <div class="card-content">
                        <div v-if="dadosProcessados" class="download-section">
                            ...
                            <div class="download-buttons">
                                <button class="btn btn-outline-primary" @click="downloadArquivo('ISD')">
                                    <i class="fas fa-download me-2"></i>ISD - Insumos SEM Desoneração
                                </button>
                                <button class="btn btn-outline-primary" @click="downloadArquivo('ICD')">
                                    <i class="fas fa-download me-2"></i>ICD - Insumos COM Desoneração
                                </button>
                                <button class="btn btn-outline-primary" @click="downloadArquivo('CSD')">
                                    <i class="fas fa-download me-2"></i>CSD - Composições SEM Desoneração
                                </button>
                                <button class="btn btn-outline-primary" @click="downloadArquivo('CCD')">
                                    <i class="fas fa-download me-2"></i>CCD - Composições COM Desoneração
                                </button>
                                <button class="btn btn-outline-primary" @click="downloadArquivo('ANALITICO')">
                                    <i class="fas fa-download me-2"></i>Analítico
                                </button>
                            </div>
                        </div>
...
<script>
/**
 * Script do Componente de Processamento de Composições e Insumos SINAPI
 * 
 * RESPONSABILIDADES:
 * - Gerenciar upload e validação de arquivos Excel
    ...
    methods: {
        ...
        async processarArquivo() {
            ...
            try {
                ...
                const response = await axios.post('/api/tabela_oficial/importar_sinapi/composicoes_insumos', formData, {
                    headers: {
        ...
        async downloadArquivo(tipo) {
            try {
                ...
                link.href = url
                link.setAttribute('download', `sinapi_${tipo.toLowerCase()}.xlsx`)
