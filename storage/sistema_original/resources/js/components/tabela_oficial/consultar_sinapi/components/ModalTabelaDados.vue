    ...
    setup(props, { emit }) {
        ...
        const carregarDados = async () => {
            try {
                ...
                const response = await axios.get('/api/tabela_oficial/consultar_sinapi/dados', {
                    params: {
                        tabela: tabelaParam
                    },
                    headers: {
        ...
        const exportarExcel = async () => {
            try {
                ...
                const tabelaParam = props.tabela.data_base + '|' + props.tabela.desoneracao
                window.open(`/api/tabela_oficial/consultar_sinapi/exportar-excel?tabela=${tabelaParam}`, '_blank')
            } catch (error) {
