    ...
    <div class="tudo fundo-imagem">
        ...
        <div class="tela">
            ...
            <div class="linha12">
                ...
                <a href="{{ route('lote.documentacao') }}"></a>
                <a href="{{ route('lote.historico') }}"></a>
                <a href="{{ route('lote.resumo') }}"></a>
            </div>
            <a href=""><div class="linha2"></div></a>
            <a href=""><div class="linha3"></div></a>
            <a href="{{ route('lote.create') }}"><div class="linha4"></div></a>
        </div>
    </div>
</div>
...
<style scoped>
    ...
    .fundo-imagem {
            ...
            background-image: url('{{ asset('/assets/images/prototipo/lote-historico.png') }}');
