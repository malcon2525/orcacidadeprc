...
return new class extends Migration
{
    ...
    {
        Schema::create('derpr_servicos', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['codigo_servico', 'codigo', 'data_base', 'desoneracao'], 'servicos_unique');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('derpr_servicos');
    }
};
