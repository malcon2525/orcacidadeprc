        ...
        <div class="card shadow-sm border-0 rounded-3 mb-4">
            ...
            <div class="card-header bg-white py-2 d-flex justify-content-between align-items-center">
                <h6 class="mb-0 fw-semibold" style="color: #5EA853; font-size: 1.2rem; padding: 5px 0;">
                    <i class="fas fa-search me-2"></i>Lista de Tabelas Oficiais (DER-PR)
                </h6>
                        ...
                        <div class="tabela-card" @click="abrirModalTabela(tabela)">
                            ...
                            <div class="card-header-section">
                                ...
                                <div class="card-title-section">
                                    <h6 class="card-title">Tabela DER-PR</h6>
                                    <p class="card-subtitle">Departamento de Estradas de Rodagem</p>
                                </div>
...
export default {
    ...
    setup() {
         ...
         */
        const getIconOrdenacao = (campo) => {
            if (ordenacao.value.campo !== campo) {
                return 'fa-sort'
            }
            return ordenacao.value.direcao === 'asc' ? 'fa-sort-up' : 'fa-sort-down'
        }
        ...
        /**
         * Função para abrir modal de tabela
         */
        ...
        /**
         * Função para fechar modal de tabela
         */
        ...
        /**
         * Carrega a lista de tabelas disponíveis do backend
         */
        const carregarTabelas = async () => {
            try {
                const response = await axios.get('/api/tabela_oficial/consultar_derpr/buscar_tabelas')
                tabelas.value = response.data
            } catch (error) {
                console.error('Erro ao carregar tabelas:', error)
                alert('Erro ao carregar tabelas disponíveis')
            }
        }
