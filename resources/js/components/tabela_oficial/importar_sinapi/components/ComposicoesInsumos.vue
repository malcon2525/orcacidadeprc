  ...
  <div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div>
        <h5 class="mb-1 fw-bold text-custom">
          <i class="fas fa-file-excel me-2"></i>Processamento de Composições e Insumos da Tabela SINAPI
        </h5>
    ...
    <div class="row g-4 mb-4">
      ...
      <div class="col-md-6 col-lg-3">
        <WorkflowCard
          ...
          description="Selecione o Excel com as 5 abas (ISD, ICD, CSD, CCD, Analítico)"
            ...
            <div v-if="status === 'available'">
              <div class="processing-section">
                <div class="processing-info">
                  <p class="mb-3 small">Inicie o processamento da tabela. Este processo pode levar alguns minutos.</p>
                </div>
                <button 
    ...
    <div v-if="currentProcessingStep" class="processing-details mb-4">
      <div class="processing-header">
        ...
        <div class="processing-info">
          <h6 class="mb-1 fw-semibold">Processando Arquivo Excel</h6>
        ...
        <div class="modal-content border-0 shadow-lg">
          ...
          <div class="modal-body p-0">
            <div class="table-responsive">
              <table class="table table-hover mb-0 composicoes-insumos-table">
                <thead>
                  <tr>
                    <th>Código</th>
                    <th>Descrição</th>
    ...
    methods: {
        ...
        async processarArquivo() {
            ...
            try {
                ...
                this.progressoEtapa = 'Extraindo dados das abas...'
                this.progresso = 50
                await this.delay(1000)
