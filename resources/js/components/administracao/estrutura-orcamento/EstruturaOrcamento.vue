                            ...
                            <div class="d-flex gap-1 justify-content-end" v-if="permissoes.crud">
                                ...
                                <tr class="adicionar-grande-item-row">
                                    ...
                                    <td colspan="3" class="text-center py-4">
                                        <button v-if="permissoes.crud" class="btn btn-outline-success d-flex align-items-center gap-2 mx-auto" 
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="text" 
                                               ...
                                               :value="form.eo_grande_item_id ? `Grande Item: ${itemSelecionado?.descricao || 'N/A'}` : ''"
                                               readonly
                                               disabled>
...
export default {
    ...
    methods: {
        ...
        async carregarDados() {
            ...
            this.loading = true;
            try {
                const response = await axios.get(`/api/administracao/estrutura-orcamento/grande-item/${this.tipoOrcamentoSelecionado}/por-tipo`);
        ...
        onTipoOrcamentoChange() {
            ...
            if (this.tipoOrcamentoSelecionado) {
                ...
                this.form.eo_tipo_orcamento_id = this.tipoOrcamentoSelecionado;
                this.$nextTick(() => {
                    this.carregarDados();
                });
            }
            ...
            try {
                ...
                if (this.modoEdicao) {
                    ...
                    response = await axios.post('/api/administracao/estrutura-orcamento/grande-item/', {
                        eo_tipo_orcamento_id: this.tipoOrcamentoSelecionado,
                        descricao: this.form.descricao,
                        ordem: this.form.ordem
                    });
                }
            ...
            try {
                ...
                if (this.modoEdicao) {
                    ...
                    response = await axios.post('/api/administracao/estrutura-orcamento/subgrupo/', {
                        eo_grande_item_id: this.form.eo_grande_item_id,
                        descricao: this.form.descricao,
                        ordem: this.form.ordem
                    });
                }
        ...
        async processarArquivoReal() {
            try {
                ...
                formData.append('eo_tipo_orcamento_id', this.tipoOrcamentoSelecionado);
